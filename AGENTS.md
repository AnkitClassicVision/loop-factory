# loop-factory — Agent Operating Manual
...
+ maps + QA + records + memory). This file is the canonical instruction set
for ANY agent working in this repo (Codex, Claude, others). CLAUDE.md mirrors
it for Claude Code.
