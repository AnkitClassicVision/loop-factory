...
|---|---|---:|---|---|
| `01_watchdog/` | `SG-WATCHDOG` | 12 | C1, C3, C4, C12, C13, C16 | every estate unit in the charter inventory was sensed this run (a missing unit is a silent-gap FAIL) (+2 more) |
