...
class RecordsLockTimeout(RuntimeError):
    """Raised when the department records lock cannot be acquired in time."""
...
def records_lock(
    ...
    """Hold the department-wide records lock or fail without writing."""
...
def write_record(
    ...
    *,
    ...
    greater than the epoch observed while holding the department-wide lock.
    The lock covers the complete ordered write sequence.
    """
    state_dir = Path(state_dir)
